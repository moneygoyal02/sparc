...
const OrganizerCard = ({
    ...
    return (
        <div className={isLocal ? 'organizer-card' : 'expert-card'}>
            <div
                className={
                    isLocal ? 'organizer-image-wrapper' : 'expert-img-wrapper'
                }
            >
                {!imgError ? (
                    <img
                    ...
                    <div className="organizer-placeholder">{initials}</div>
                )}
            </div>
            {isLocal && <div className="organizer-role">{role}</div>}
            <h3 className={isLocal ? 'organizer-name' : 'expert-name'}>
                {name}
            </h3>
...
function Organizers() {
    ...
    const committeeMembers = [
        'Prof. Joseph Anand Vaz',
        'Prof. Subhash Chander',
        'Prof. Raman Bedi',
        'Prof. Pramod Kumar',
        'Prof. Dinesh Kumar Shukla',
        'Er. Ajay Trehan',
        'Dr. R. S. Bharj',
        'Dr. Rajeev Kukreja',
        'Dr. S. K. Tiwari',
